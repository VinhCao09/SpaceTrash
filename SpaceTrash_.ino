...
void st_Draw(uint8_t fps)
{
  ...
  { 
    ...
    case ST_STATE_IPREPARE:
      ...
      u8g2_DrawStr(st_u8g2, 18, u8g_height_minus_one - (st_u8g2->height-6)/4, "GAME BAN VU TRU");
      u8g2_DrawStr(st_u8g2, 31, u8g_height_minus_one - (st_u8g2->height-26)/2-25, "VINH CAO");
      u8g2_DrawStr(st_u8g2, 18, u8g_height_minus_one - (st_u8g2->height-1)/2, "Loading game...");
      //dog_SetHLine(st_u8g2->width-st_to_diff_cnt-10, st_u8g2->width-st_to_diff_cnt, (st_u8g2->height-6)/2-1);
      u8g2_DrawHLine(st_u8g2, st_u8g2->width-st_to_diff_cnt-10, u8g_height_minus_one - (st_u8g2->height-3)/2+3, 11);
      break;
    case ST_STATE_GAME:
      st_DrawInGame(fps);
      break;
...
void loop(void) {
  ...
  Serial.println ("   ");
    ...
    u8g2.firstPage();
   if( digitalRead(pin_fire)){digitalWrite(2, HIGH);} else {digitalWrite(2, LOW);}
